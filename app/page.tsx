...
export default async function Home() {
  ...
  return (
    <main style={{ padding: "40px 20px", maxWidth: "1200px", margin: "0 auto", backgroundColor: "#000", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "30px", alignItems: "center" }}>
        <h1 style={{ color: "#fff", fontSize: "24px" }}>🏠 Hệ Thống Thuê Nhà</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "25px" }}>
        {listings.map((item: any) => (
          <div key={item._id} style={{ backgroundColor: "#111", borderRadius: "15px", overflow: "hidden", border: "1px solid #222", position: "relative" }}>
            ...
            {/* Thông tin - Chú ý phần tên biến ở đây */}
            <div style={{ padding: "15px" }}>
              <h2 style={{ color: "#fff", fontSize: "18px", margin: "0 0 10px 0" }}>
